...
<script type="text/javascript">
	...
	$(function(){
		...
		//在页面加载完毕后，在工作区打开相应的页面，workareaFrame：前端布局相关的信息，main/index.html是相对路径，webapp是根
		//当集成了base标签(<base href="<%=basePath%>">)之后,所有的路径都要变成绝对路径，否则相对路径不识别
			...
			<ul>
				<li class="dropdown user-dropdown">
					<a href="javascript:void(0)" style="text-decoration: none; color: white;" class="dropdown-toggle" data-toggle="dropdown">
						<span class="glyphicon glyphicon-user"></span> ${user.name} <span class="caret"></span><!--sessionScope.user.name相当于getAttribute("user",user).name,但所有带Scope的域对象都可以省略-->
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</a>
