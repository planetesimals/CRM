...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        //(1)通过线索id获取线索对象（线索对象当中封装了线索的信息），把公司相关的信息转换成客户，把对象相关的信息转换成联系人
        Clue c = clueDao.getById(clueId);

        //(2) 通过线索对象提取客户信息，当该客户不存在的时候，新建客户（根据公司的名称精确匹配，判断该客户是否存在！），因为在搜集的线索后，这个线索对象有可能是客户，但没有匹配过客户欣喜
        ...
        if(t!=null){
            ...
            //(7)如果创建了交易，则创建一条该交易下的交易历史,一条交易对应多条交易历史，一对多
