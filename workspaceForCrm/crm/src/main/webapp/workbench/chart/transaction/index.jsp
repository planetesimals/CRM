        ...
        function getCharts() {
            ...
            $.ajax({
                ...
                success : function (data) {
                    ...
                    // 基于准备好的dom，初始化echarts实例，下一句代码是粘来的，目的是告诉div,我要在里面画图了
                    ...
                    //使用刚指定的配置项和数据显示图表，代码可以从ECharts官网粘，官网有详细注释，解释过程
...
<body>
    ...
    <!-- 为 ECharts 准备一个具备大小（宽高）的 DOM (宽600，高400的盒子）-->
