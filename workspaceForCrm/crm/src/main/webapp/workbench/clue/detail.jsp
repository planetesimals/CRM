        ...
        $(function(){
            ...
            $("#aname").keydown(function (event) {
                ...
                if(event.keyCode==13){
                    ...
                    //展现完列表后，记得将模态窗口默认的回车行为（强制刷新页面，并且清空数据）禁用掉
                    return false;
                    ...
                    $.ajax({
                        ...
                        success : function (data) {
                            ...
                            if(data.success){
                                ...
                                //清除搜索框中的信息  复选框中的√干掉 清空activitySearchBody中的内容（赋空窜）
                ...
                success : function (data) {
                    ...
                    $.each(data,function (i,n) {
                        ...
                        html += '<td><a href="javascript:void(0);" onclick="unbund(\''+n.id+'\')" style="text-decoration: none;"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>';
                                                                //动态生成的标签不能直接加Id，得在中间加onclick，往里加个Id，此时的Id在dao中设成了关联关系表的id
                        html += '</tr>';
...
<div style="position: relative; left: 40px; top: -30px;">
    ...
    <div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">  <!--以这种不过后台的形式携带参数跳转页面，要满足两个条件，1.参数中没有密码之类不可见的信息，2.加了参数后的请求长度不能过长，超过浏览器请求的限制-->
